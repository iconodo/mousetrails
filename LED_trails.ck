...
t_blazer.size( t_blazer.width(), t_blazer.height() );
t_blazer.light();
t_blazer.position( 0, 0);
t_blazer.unlight();
control_view.addElement( t_blazer );
    ...
    while( true )
    {
        ...
        while( hint.recv( msg ) )
        {
            ...
            if( msg.isMouseMotion() )
            {
              ...
              t_blazer.position(t_blazer.x()+msg.deltaX$int,
                        t_blazer.y());
                ...
                if( msg.deltaY )
                {
                  ...
                  t_blazer.position(t_blazer.x(),
                        t_blazer.y()+msg.deltaY$int);
...
//                t_blazer.position(t_blazer.x()+laX2$int,
//                        t_blazer.y()+msg.deltaY$int);
 
  <<< "TB's coords:", t_blazer.x(),",",t_blazer.y()>>>;
       if (on_button.x() - t_blazer.x() <= 25 &&
           t_blazer.x() - on_button.x() <= 25  &&
           on_button.y() - t_blazer.y() <= 25 &&
           t_blazer.y() - on_button.y() <= 25) 
